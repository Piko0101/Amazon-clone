      ...
      <div className="home__container ">
        ...
        <div className="home__row">
          ...
          <Product
            ...
            price={239.0}
            rating={4}
            image="https://m.media-amazon.com/images/I/71d-rb2c-7L._AC_UY218_.jpg"
          />
        </div>
        <div className="home__row">
          <Product
          ...
          <Product
            ...
            rating={4}
            image={
              "https://m.media-amazon.com/images/I/81MF389-9gS._AC_UY218_.jpg"
            }
          />
          <Product
            id="369874"
            ...
            rating={5}
            image={
              "https://m.media-amazon.com/images/I/61ohGh70oeL._AC_UY218_.jpg"
            }
          />
        </div>
        <div className="home__row">
          <Product
            ...
            rating={3}
            image={
              "https://m.media-amazon.com/images/I/61XDeaOrrKL._AC_SL1000_.jpg"
            }
          />
        </div>
      </div>
